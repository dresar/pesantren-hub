...
export const founders = pgTable('core_founders', {
  ...
  profilSingkat: text('profil_singkat').notNull(),
  bioLengkap: text('bio_lengkap'),
...
export const programs = pgTable('core_program', {
  ...
  tipe: varchar('tipe', { length: 100 }).default('Reguler'),
  durasi: varchar('durasi', { length: 100 }).default('3 Tahun'),
  keunggulan: text('keunggulan').default('Kurikulum Terpadu\nTenaga Pengajar Profesional\nFasilitas Lengkap\nEkstrakurikuler Beragam'),
  galeri: text('galeri'),
  metaTitle: varchar('meta_title', { length: 200 }).notNull(),
  metaDescription: text('meta_description').notNull(),
  order: integer('order').notNull(),
